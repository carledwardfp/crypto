...
import { useGetCoinDataQuery } from '../../../services/globalDataApi'
...
const Coin: React.FC<CoinProps> = ({ id }) => {
  const { data: coinData, isFetching, isError } = useGetCoinDataQuery(id)
  const coin = coinData?.data?.coin as ICoinData
